  ...
  return (
    <div className='flex justify-center items-center  min-h-[500px] md:flex-row flex-col gap-10 relative mb-36 pt-[10rem]'>
      ...
      <div className='flex-1 z-[2]'>
        <div
          className='sm:text-[50px] md:text-left text-center '
        ...
        >
          <h1 className='md:items-start text-[50px] title flex flex-col items-center leading-none font-bold relative'>
            <span className='flex mb-2 leading-3 title items-center'>
              Adrian
              <span className='ml-2 manoSaludando'>
                <ManoSaludando />
              </span>
            </span>
          ...
          <p
            className='text-sm font-normal description-hero mt-4'
        ...
        <div className='flex mt-5 sm:text-[17px] md:justify-start text-[16px] justify-center'>
          <Button
            ...
            href='https://drive.google.com/uc?export=download&id=1EL76klHFd0rR_Jo3RjAsvPmQ6uxetjkX'
            isDowload
            hover='#051f2c'
          >
          ...
          <Button
            style={{ border: '1px solid #7d7d7d', color: Themes.text }}
            href='#contact'
          >
            Contacto
          </Button>
      ...
      <div className='flex-1 z-[2] relative md:flex-row flex-col h-[400px] justify-center items-center lg:flex hidden'>
        <div
          className='w-[410px] flex justify-center relative items-center  h-[410px] rounded-full'
        ...
        >
          <div className='w-[410px] flex justify-center top-0 atom left-0 items-center h-[410px] rounded-full absolute'>
            <div
              className='w-[50px] h-[50px] rounded-full absolute bottom-[45px] flex justify-center items-center text-3xl right-[30px]'
              style={{ background: Themes.text, color: Themes.iconHero }}
            >
              <FaReact />
            </div>

            <div
              className='w-[50px] flex justify-center items-center text-3xl h-[50px] rounded-full absolute -top-[27px]'
              style={{ background: Themes.text, color: Themes.iconHero }}
            >
              <DiJavascript1 />
            </div>
            ...
            <div
              className='w-[50px] flex justify-center items-center text-3xl h-[50px] rounded-full absolute -left-[25px]'
              style={{ background: Themes.text, color: Themes.iconHero }}
            >
              <DiNodejsSmall />
            </div>
          ...
          <div
            className='w-[320px] overflow-hidden justify-center items-center flex h-[320px] rounded-full'
            style={{ background: '#0000002d', backdropFilter: 'blur(60px)' }}
          >
            <img
              src='https://res.cloudinary.com/dynscts1t/image/upload/v1683821025/Adrian_Avila_Diaz_pic_w9mdhp.jpg'
              alt='xs'
              loading='lazy'
